...
import { ref } from "vue";
import { authorityRight } from "./authorityRight";
import { watch } from "vue";
const mothed = {
  postPath: "/userRole/inserts", //插入
  deletePath: "/userRole/deletes/", //删除
  queryPath: "/authority/getByRoleId/",
  addListPath: "/authority/getByRoleIdNot/",
};
...
const { addcolumns, queryucolumns } = authorityRight(deleteData, Add);
watch(
  () => props.roleid,
  () => {
